...
<main>
  ...
  {:else if lessonUnavailable}
    <section class="notice" aria-labelledby="unavailable-heading">
      <h1 id="unavailable-heading">No lesson today</h1>
      <p>Today’s lesson has not been published yet.</p>
      <p><a href="/">Back to your learning calendar</a> · <a href="/alphabet">French alphabet pronunciation</a></p>
    </section>
  {:else if !lesson}
